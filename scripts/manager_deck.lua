...
-- Are players allowed to grab cards from the card table and drag them to their hand
-- Default: yes
DECK_SETTING_PLAYERS_CAN_GRAB_FROM_TABLE = "playerscangrabfromtable"
...
local _tSettingOptions = {
	...
	[DECK_SETTING_PLAYERS_CAN_GRAB_FROM_TABLE] = {
		default = "yes",
		options = {
			{ sTextRes = "deckbox_setting_option_yes", sValue = "yes" },
			{ sTextRes = "deckbox_setting_option_no", sValue = "no" },
